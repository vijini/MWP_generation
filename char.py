...
filepath="SinhalaMultipleSentence-improvement-{epoch:02d}-{loss:.4f}-big.hdf5"
...
filename = "SinhalaMultipleSentence-improvement-15-0.4050-big.hdf5"
...
candidate, references = fetch_data('generated.txt','Sinhala_multipleSentenced.txt')
